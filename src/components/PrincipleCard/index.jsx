...
// owns a `linear` toggle that swaps the fill curve. Declared at module scope so
// React does not treat it as a new component on every render of
...
function ProgressBarDemo({ uiMode }) {
...
//
// uiMode is threaded to P06 so its demo can flash the "Tokens" title the
...
function getPrincipleComponent(principleId, drawerOpen, setDrawerOpen, uiMode) {
  switch (principleId) {
    ...
    case 6:
      return <ProgressBarDemo uiMode={uiMode} />
    case 8:
      return (
