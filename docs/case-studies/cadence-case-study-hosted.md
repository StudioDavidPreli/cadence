...
<div style="display: flex; gap: 40px; flex-wrap: wrap; margin: 24px 0 8px 0; font-family: 'IBM Plex Mono', ui-monospace, monospace;">
  ...
  <a href="#key-decisions" style="text-decoration: none;">
...
<!-- V09: live Rive Clock embed (?embed=rive-clock&theme=dark). Canvas only; a ghost pointer
     ...
     The fallback SVG sits behind the iframe as its background. -->
<figure style="float: right; width: 340px; max-width: 100%; margin: 0 0 16px 24px;">
  ...
  <figcaption style="font-size: 12px; color: #909090; margin-top: 8px;">Live: the Rive Clock. The color plates chase a cursor on token timing; when nobody is there, a ghost takes the tour. A click on the cloud waters the plant.</figcaption>
</figure>
