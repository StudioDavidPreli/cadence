...
[Cadence: Case Study](index.md) · [The Principles](principles.md), all eighteen

---

Each of the eighteen carries the same four fields: the component, the tokens driving it, the key decision, and what it demonstrates.
...
[← The Principles](principles.md) · [Fields and Canvases →](fields-and-canvases.md)
